...
namespace TouchScript.Behaviors.Cursors
{
    ...
    public class ObjectThreeCamera : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (Manager.GameManager.CamStreetGo != null)
            {
            }
        ...
        private void OnEnable()
        {
            ...
            CamObject = Manager.GameManager.CamStreetGo.transform;
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                if (pointer.Type == Pointer.PointerType.Object && pointer.ObjectId == objectTrackerID)
                {
                    ...
                    _rv.RequestOwnership();
                     Manager.GameManager.activateCamStreet();
