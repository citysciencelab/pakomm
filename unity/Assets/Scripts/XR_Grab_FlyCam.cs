...
public class XR_Grab_FlyCam : XRBaseInteractable
{
    ...
    private void Start()
    {
        ...
        Debug.Log("Ich bin Start vom XR GRAB FLY_PAKOMM");
    ...
    protected override void OnSelectExited(SelectExitEventArgs args)
    {
        ...
        _xrRayInteractor.raycastMask = LayerMask.GetMask("Landscape", "Default", "Grabbable", "Menu", "Teleport");
