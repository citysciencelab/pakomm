...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public class XRTintAnnotation : MonoBehaviour
    {
        ...
        protected virtual void SetTint(bool on)
        {
            ...
            var emissionColor = on ? m_TintColor * Mathf.LinearToGammaSpace(1f) : pastColor;
            ...
            foreach (var render in m_TintRenderers)
            {
                ...
                pastColor = gameObject.GetComponent<Renderer>().material.GetColor("_Color");
        ...
        {
            public static readonly int emissionColor = Shader.PropertyToID("_Color");
        }
    }
}
